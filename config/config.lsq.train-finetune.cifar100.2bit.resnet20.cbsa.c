...
case='cifar100-lsq-finetune-2bit-pytorch-TypeC-wd1e-4-wt_qg1_var-mean-sgd_0'
keyword='cifar100,origin,cbsa,fix_pooling,singleconv,fix,ReShapeResolution,real_skip,dorefa,lsq'

pretrained='cifar100-EfficientQuant-stratch-fp-pytorch-TypeC-sgd_0-model_best.pth.tar'
